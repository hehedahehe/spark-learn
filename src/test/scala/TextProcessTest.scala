...
class TextProcessTest extends FunSuite{
  ...
  val FILE_PATH = "E:\\Work\\DATA_SET\\TextData\\TheValleyofFear.txt"
  val FILE_OUT_PATH = "E:\\Work\\DATA_SET\\TextData\\result_temp\\"
  ...
  test("WordCount 按照词频降序排序"){
    ...
    wordsSortedByValue.saveAsTextFile(FILE_OUT_PATH+"WC_SORT1")
  }
